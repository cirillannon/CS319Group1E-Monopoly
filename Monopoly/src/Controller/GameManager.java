...
import communication.PlayerDeserializer;
...
public class GameManager
{
	...
	{
		System.out.println("in is dice rolled -> ");
	...
	{
		System.out.println("gamemanager updatePlayers");
...
//		}
	...
	public void turnEnded()
	{
		...
		req.addProperty("all_players", gson.toJson(players));
		req.addProperty("turn", gson.toJson( turn));

		Monopoly.gameManager.client.sendRequest( req);
	}
