...
public class Player {
    ...
    public boolean updateBalance(int changeBalance){
        ...
        if(this.balance < 0 && propertiesOwned.size() == 0) {
            ...
            this.balance -= changeBalance;
            System.out.println("not enough money. Do you want to sell a property? (yes/no)");
            return false;
        } else {
            return true;
        }
    ...
    public void move(int diceTotal){
        ...
        System.out.println(getPlayerName() + " in " + GameBoard.getTile(location).getTileName());
    }
    ...
    public void playTurn() {
        ...
        if(isInJail()){
            Dice.rollDice();
            System.out.println(getPlayerName() + ": " + Dice.d1() + ", " + Dice.d2());
            if(Dice.getDoubles()) {
